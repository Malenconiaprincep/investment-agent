...
const TASKS: Array<Omit<ScheduledTaskStatus, 'enabled'> & { defaultEnabled: boolean }> = [
  ...
  },
  {
    ...
    label: 'ETF 观察快照',
    description: '收盘后汇总数据、自动交易、回撤和策略行为，沉淀实盘前观察日志',
    scheduleText: '交易日 15:45',
    defaultEnabled: true,
  },
  {
    id: 'watchlist-snapshot',
    label: '跟踪池快照',
    description: '收盘后刷新跟踪池行情、钻石信号，并自动移出过期观察标的',
  ...
  {
    id: 'stock-backtest-exit-monitor',
    label: '回测策略分仓出场监控',
    description: '交易时段监控策略仓与新闻仓的止盈/止损/持有到期等出场条件并自动卖出',
    scheduleText: '交易日 9:30–15:00 轮询',
    defaultEnabled: true,
  },
  {
