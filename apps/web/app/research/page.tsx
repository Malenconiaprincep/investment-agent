...
export default function ResearchPage() {
  ...
  return (
    <main className="page page--workspace">
      <PageHeader
        title="单股研究"
        description="输入股票代码生成结构化研报，适合作为跟踪池、智能扫描和模拟验证前的第一步。"
      />
      ...
      <div className="page-workspace">
        <aside className="page-pane page-pane--sidebar page-pane--scroll">
          <div className="dashboard-grid dashboard-grid--compact">
            ...
            <button
              type="button"
              className="dashboard-tile dashboard-tile--button"
              onClick={() => setOpen(true)}
            >
              <h2 className="dashboard-tile-title">跟踪池</h2>
              <p className="dashboard-tile-desc">
                右侧展开查看雷达自动跟踪的标的与信号状态。
              </p>
            </button>
